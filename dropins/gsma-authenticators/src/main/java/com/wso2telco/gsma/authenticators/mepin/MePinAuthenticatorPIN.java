...
/**
 * The Class MePinAuthenticatorPIN.
 */
public class MePinAuthenticatorPIN extends AbstractApplicationAuthenticator
    ...
    /** The log. */
    private static Log log = LogFactory.getLog(MePinAuthenticatorPIN.class);
    
    /** The loa. */
    private static String LOA = "pin";
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (context.isRetrying()) {
                ...
                DBUtils.insertUserResponse(context.getContextIdentifier(), String.valueOf(MePinAuthenticatorPIN
            ...
            if (serviceProviderName.equals("wso2_sp_dashboard")) {
                serviceProviderName = "Mobile connect";//DataHolder.getInstance().getMobileConnectConfig().getUssdConfig().getDashBoard();
            }

//            JsonObject transactionRes = new MePinQuery().createTransaction(mePinId, context.getContextIdentifier(),
//                    serviceProviderName, MePinAuthenticatorPIN.LOA);
            MePINAuthenticatorSelectorImpl mePINAuthenticatorSelector = new MePINAuthenticatorSelectorImpl();
            JsonObject transactionRes = mePINAuthenticatorSelector.getMePINPIN(mePinId, context.getContextIdentifier(),
                    serviceProviderName, MePinAuthenticatorPIN.LOA);
    ...
    public String getName() {
        return Constants.MEPIN_AUTHENTICATOR_PIN_NAME;
    }
