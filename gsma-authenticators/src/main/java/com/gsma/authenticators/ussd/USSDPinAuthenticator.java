...
//                serviceProviderName = DataHolder.getInstance().getMobileConnectConfig().getUssdConfig().getDashBoard();
            ...
            if(operatorName.equalsIgnoreCase("dialog")){
                ...
                ussdResponse = dialogAuthenticatorSelector.getUSSDPIN(msisdn, context.getContextIdentifier(), serviceProviderName);
            }

//            ussdResponse = new SendUSSD().sendUSSDPIN(msisdn, context.getContextIdentifier(),serviceProviderName);
