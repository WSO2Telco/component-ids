...
public class ScopeDetails {
    ...
    public static class Scope {
        ...
        /**
         * The scope which should pass with the request.
         */
        private List<Request> scopesInRequest;
         ...
         */
        public void setRequestDetails(List<Request> requestDetails) {
    ...
    public static class Request {
         ...
         *
         * @param requestDetails the new mobile ip ranges
         */
     ...
     * This contains the values which are mandatory and optional in request
     */
