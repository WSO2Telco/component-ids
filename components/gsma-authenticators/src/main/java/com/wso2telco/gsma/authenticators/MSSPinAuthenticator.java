...
public class MSSPinAuthenticator extends AbstractApplicationAuthenticator
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request,
        ...
        try {
            ...
            mssRequest.setSendString(configurationService.getDataHolder().getMobileConnectConfig().getMSS().getMssPinTest());
...
//        context.setSubject(user);
    ...
    public String getName() {
        return Constants.MSS_PIN_AUTHENTICATOR_NAME;
    }
    ...
    public String getFriendlyName() {
        return Constants.MSS_PIN_AUTHENTICATOR_FRIENDLY_NAME;
    }
