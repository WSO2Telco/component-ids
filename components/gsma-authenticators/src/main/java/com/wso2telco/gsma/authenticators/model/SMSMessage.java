...
public class SMSMessage {
    ...
    private BasicFutureCallback futureCallback;
    ...
    public BasicFutureCallback getFutureCallback() {
        return futureCallback;
    }

    public void setFutureCallback(BasicFutureCallback futureCallback) {
