...
public class MePINAuthenticatorSelectorImpl extends MePINAuthenticatorSelector {
    ...
    /* (non-Javadoc)
     * @see com.wso2telco.gsma.authendictorselector.MePINAuthenticatorSelector#getMePINPIN(java.lang.String, java
     * .lang.String, java.lang.String, java.lang.String)
     */
    @Override
    public JsonObject getMePINPIN(String mepinID, String sessionID, String serviceProvider, String
            confirmation_policy) throws SAXException, ParserConfigurationException, XPathExpressionException,
            IOException {
