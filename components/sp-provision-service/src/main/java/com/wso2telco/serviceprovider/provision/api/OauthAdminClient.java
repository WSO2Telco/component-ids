...
//            if (environment.equalsIgnoreCase("preprod")) {
                host = "https://localhost:9444";//popertiesFromPropertyFile.getProperty("host_preprod_IS");
                userName = "admin";//popertiesFromPropertyFile.getProperty("preprod_IS_Username");
                password = "admin";//popertiesFromPropertyFile.getProperty("preprod_IS_password");
...
//
//    public OauthAdminClient() {
//        String host = "https://localhost:9444";//mobileConnectConfigs.getSpProvisionConfig().getApiManagerUrl(); //popertiesFromPropertyFile.getProperty("host_preprod_IS");
