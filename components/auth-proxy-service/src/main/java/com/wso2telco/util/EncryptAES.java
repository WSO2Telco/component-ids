...
/**
 * This class used to encrypt the user information.
 */
public class EncryptAES {
	...
	public static String encrypt(String plainText)
			throws JAXBException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException,
			       BadPaddingException, IllegalBlockSizeException, AuthProxyServiceException {
		...
		if (mobileConnectConfigs != null) {
			...
			throw new AuthProxyServiceException("MSISDN EncryptionKey could not be found in mobile-connect.xml");
		}
