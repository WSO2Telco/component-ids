...
public final class Constants {
    ...
    /** The Constant WHITELIST_MSISDN_AUTHENTICATOR_NAME. */
    public static final String WHITELIST_MSISDN_AUTHENTICATOR_NAME = "WhiteListMSISDNAuthenticator";
    
    /** The Constant WHITELIST_MSISDN_AUTHENTICATOR_FRIENDLY_NAME. */
    public static final String WHITELIST_MSISDN_AUTHENTICATOR_FRIENDLY_NAME = "wmsisdn";
    
    /** The Constant WHITELIST_MSISDN_AUTHENTICATOR_STATUS. */
    public static final String WHITELIST_MSISDN_AUTHENTICATOR_STATUS = "WhiteListMSISDNAuthenticatorStatus";
    ...
    public static final String LISTNER_WEBAPP_MEPIN_CONTEXT = "/MediationTest/tnspoints/endpoint/mepin/response";
