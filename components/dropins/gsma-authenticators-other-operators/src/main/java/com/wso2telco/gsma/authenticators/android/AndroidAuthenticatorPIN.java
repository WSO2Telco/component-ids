...
/**
 * The Class AndroidAuthenticatorPIN.
 */
public class AndroidAuthenticatorPIN extends AbstractApplicationAuthenticator
    ...
    /** The log. */
    private static Log log = LogFactory.getLog(AndroidAuthenticatorPIN.class);
    
    /** The Constant PIN_CLAIM. */
    private static final String PIN_CLAIM = "http://wso2.org/claims/pin";
    
    /** The loa. */
    private static String LOA = "loa3";
...
//        }
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request,
        ...
        try {
            ...
            try {
                serviceProviderName = AndroidAuthenticatorPIN.getAppInformation(context.getRelyingParty()).getApplicationName();
            } catch (IdentityOAuth2Exception ex) {
                Logger.getLogger(AndroidAuthenticatorPIN.class.getName()).log(Level.SEVERE, null, ex);
...
//        context.setSubject(msisdn);
    ...
    public String getName() {
        return Constants.ANDROID_AUTHENTICATOR_PIN_NAME;
    }
