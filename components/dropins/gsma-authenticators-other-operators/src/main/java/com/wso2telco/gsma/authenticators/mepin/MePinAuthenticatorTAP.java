...
/**
 * The Class MePinAuthenticatorTAP.
 */
public class MePinAuthenticatorTAP extends AbstractApplicationAuthenticator
    ...
    /** The log. */
    private static Log log = LogFactory.getLog(MePinAuthenticatorTAP.class);

    /** The loa. */
    private static String LOA = "tap";
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (context.isRetrying()) {
                ...
                DBUtils.insertUserResponse(context.getContextIdentifier(), String.valueOf(MePinAuthenticatorTAP
            ...
            JsonObject transactionRes = new MePinQuery().createTransaction(mePinId, context.getContextIdentifier(),
                    serviceProviderName,MePinAuthenticatorTAP.LOA);
    ...
    public String getName() {
        return Constants.MEPIN_AUTHENTICATOR_TAP_NAME;
    }
