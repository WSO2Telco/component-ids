...
public class Customer {
    ...
    public String getIsLostStolen() {
        return isLostStolen;
    }

    public void setIsLostStolen(String isLostStolen) {
    ...
    public void setPairingChange(String pairingChange) {
        this.pairingChange = pairingChange;
    }
    ...
    public String getIsDivertSet() {
        return isDivertSet;
    }

    public void setIsDivertSet(String isDivertSet) {
        this.isDivertSet = isDivertSet;
    }
    ...
    public String getBilingSegment() {
        return bilingSegment;
    }

    public void setBilingSegment(String biilingSegment) {
        this.bilingSegment = biilingSegment;
    }
}
