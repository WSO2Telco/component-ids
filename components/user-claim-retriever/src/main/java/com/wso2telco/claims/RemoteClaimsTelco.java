...
public class RemoteClaimsTelco implements RemoteClaims{
    ...
    public Map<String, Object> getTotalClaims(String operatorEndPoint, String msisdn) {
        ...
        totalClaims.put("BillingSegment", customer.getLastName());
