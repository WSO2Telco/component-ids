...
/**
 * The Class ClaimInfoRequestValidator.
 */
public class ClaimInfoRequestValidator implements UserInfoRequestValidator {

    /* (non-Javadoc)
     * @see org.wso2.carbon.identity.oauth.user.UserInfoRequestValidator#validateRequest(javax.servlet.http.HttpServletRequest)
     */
