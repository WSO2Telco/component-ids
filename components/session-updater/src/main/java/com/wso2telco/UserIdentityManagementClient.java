...
public class UserIdentityManagementClient {
     ...
     * @throws UserIdentityManagementAdminServiceIdentityMgtServiceExceptionException the user identity management
     *                                                                                admin service identity mgt
     *                                                                                service exception exception
     */
    public void lockUser(String username) throws RemoteException,
            UserIdentityManagementAdminServiceIdentityMgtServiceExceptionException {
