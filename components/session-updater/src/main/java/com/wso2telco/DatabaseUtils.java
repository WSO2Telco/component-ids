   ...
   private static Log log = LogFactory.getLog(DatabaseUtils.class);
    ...
    public static void deleteUser(String username) throws SQLException {
   	...
   	public static List<LoginHistory> getLoginHistory(String userId, String application, Date fromDate, Date toDate) throws SQLException {
        ...
        StringBuilder sql = new StringBuilder("SELECT id, reqtype, application_id, authenticated_user, isauthenticated, authenticators, ipaddress, created_date ")
                .append("FROM ")
    ...
    public static List<String> getLoginApps(String userId) throws SQLException {
        ...
        StringBuilder sql = new StringBuilder("SELECT distinct application_id ")
                .append("FROM ")
                .append(DBTableNames.SP_LOGIN_HISTORY.getTableName())
                .append(" ")
    ...
    public static String getMePinSessionID(String transactionId) throws SQLException{
        ...
        StringBuilder sql = new StringBuilder("SELECT session_id FROM ")
