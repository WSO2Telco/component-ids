...
<head>
  ...
  <!--[if IE]>
        ...
        <script src="js/mepin_waiting.js"></script>
      </head>
    ...
    <main class="site__main site__wrap section v-distribute">
      <header class="page__header">
        ...
        <%--</h1>--%>
       <div>
        <%--<p><strong>Please follow instructions that you receive on your mobile device</strong></p>--%>
           <a href="https://app.mepin.com/complete" class="btn btn--outline btn--full btn--large">
               Complete Enrollment
           </a>
      </div>
    </header>
